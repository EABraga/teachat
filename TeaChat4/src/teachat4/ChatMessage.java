...
public class ChatMessage implements Serializable {
    ...
    ChatMessage(int type, String message, String cor, int iCripto) throws IOException {
    ...
    ChatMessage(int type, String message, byte[] bMsg, String cor, int iCripto) throws IOException {
