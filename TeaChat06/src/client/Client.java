...
public class Client  {
    ...
    public boolean start() throws IOException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException, NoSuchAlgorithmException, NoSuchPaddingException {
    	...
    	// Adicionando variabilidade por meio de Pré-Processamento
        //#if bLogin
//@       		display("Só mostra esta mensagem se a opção 'LOGIN' estiver habilitada no modelo.");
    	//#endif

        //#if bCripto
       		display("Só mostra esta mensagem se a opção 'CRIPTO' estiver habilitada no modelo.");
    	//#endif
